...
class VariationalAutoencoder(object):
    ...
    def _initialize_weights(self, n_hidden_recog_1, n_hidden_recog_2, n_hidden_recog_3,
        ...
        all_weights['weights_recog'] = {
            ...
            'h2': tf.Variable(xavier_init(n_hidden_recog_2, n_hidden_recog_3)),
...
network_architecture = \
    dict(n_hidden_recog_1=200, # 1st layer encoder neurons
         ...
         n_hidden_recog_3=200, # 3rd layer encoder neurons
         n_hidden_gener_1=200, # 1st layer decoder neurons
         n_hidden_gener_2=200, # 2nd layer decoder neurons
         n_hidden_gener_3=200, # 3rd layer decoder neurons
